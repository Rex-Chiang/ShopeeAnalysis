"""
Django settings for ShopeeAnalysisDjango project.
...
SECRET_KEY = '&dfzr9cja^&bu2qazo9kg@n-w9+v^svuh@j9a_u(o3^3q+))ip'
...
ROOT_URLCONF = 'ShopeeAnalysisDjango.urls'
...
WSGI_APPLICATION = 'ShopeeAnalysisDjango.wsgi.application'
